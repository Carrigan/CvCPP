...
/*** NOTE!!
 * This files should include "core_cm0plus.h" but cannot currently because 
 * the updated version of KEIL has not been installed on my machine
  *********************************************************************/
